...
\begin{itemize}
	...
	\item I need to compare the runtime of the current approach (iteratively finding max) and the runtime of this algorithm for finding max. [In Progress]
	\item Ensure that the 'trick' to make it work with negative numbers works. [Not Started]
\end{itemize}
